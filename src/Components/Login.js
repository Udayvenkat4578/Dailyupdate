...
const Login = () => {
  ...
  return (
    <div className="min-h-screen w-full grid md:grid-cols-2">
      {/* Left side image for desktop / background image on mobile */}
      <div className="relative hidden md:block">
        <img
          src="https://illustrations.popsy.co/blue/login.svg" // You can use your animated illustration or SVG here
          alt="Login visual"
