  ...
  return (
    ...
    <div id='C1'className='lg:px-11 lg:ml-5 lg:pr-7 lg:mr-5 md:px-11 mg:mx-11 px-1 ml-6 pr-0 mr-6  pt-11 z-2 relative'>
        ...
        <div data-aos="fade-up" data-aos-duration="1000" >
            ...
            <div className='grid grid-cols-1 place-items-center'> <div className='text-white font-extrabold sm:text-[48px] text-[36px]  '>FOLLOW ME</div><div className='text-white font-extrabold sm:text-[24px] text-[20px] '> ACROSS PLATFORMS</div><div className='text-white pt-2'>Let’s connect and build a community that thrives on creativity and innovation. Follow along to join the journey!</div></div>

            </div>
        <div className='grid grid-cols-2 lg:grid-cols-6 md:grid-cols-5 sm:grid-cols-4 place-items-center sm:gap-6 gap-3 sm:pb-11 pb-3 sm:pt-8 pt-4'>
